...
export const AccountApi = (process.env.NODE_ENV === 'production') ?
  'https://authen.jxdd.com:8443/account/account/' + ACC_API_VERSION : 'http://192.168.10.10:8080/account2/account' + ACC_API_VERSION

export const AccountAdminApi = (process.env.NODE_ENV === 'production') ?
  'https://authen.jxdd.com:8443/account/account/admin/' + ACC_API_VERSION : 'http://192.168.10.10:8080/account2/account/admin' + ACC_API_VERSION

export const AccountStoreApi = (process.env.NODE_ENV === 'production') ?
  'https://authen.jxdd.com:8443/account/account/store/' + ACC_API_VERSION : 'http://192.168.10.10:8080/account2/account/store' + ACC_API_VERSION
